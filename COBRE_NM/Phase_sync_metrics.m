...
ORG_PROJECT='/Users/HDF/Dropbox/Fran/Academics/PhD/matlab/projects/COBRA_COMPLEXITY_PHASE_FD/';
HCP_MAT_DATA=[ORG_PROJECT 'COBRE_MAT_R'];
...
for run=1:1
    ...
    save([PROJECT MET_FOLDER 'LEiDA_KOP_ALL_RUN' num2str(run) ], 'RSN_META_ALL', 'RSN_SYNC_ALL',...
