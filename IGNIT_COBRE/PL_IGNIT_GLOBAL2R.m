...
VAR1=struct2array(load([SOURCE_PROJECT '/RUN1/LEiDA_KOP_ALL_RUN1.mat'],'ICN_EV_ALL_MEAN'));
VAR2=struct2array(load([SOURCE_PROJECT '/RUN2/LEiDA_KOP_ALL_RUN2.mat'],'ICN_EV_ALL_MEAN'));
...
TRANS1=struct2array(load([SOURCE_PROJECT '/RUN1/LEiDA_KOP_ALL_RUN1.mat'],'TRANSITIONS'));
TRANS2=struct2array(load([SOURCE_PROJECT '/RUN2/LEiDA_KOP_ALL_RUN2.mat'],'TRANSITIONS'));
TRANS=cat(2,TRANS1,TRANS2);

META1=struct2array(load([SOURCE_PROJECT 'RUN1/LEiDA_KOP_ALL_RUN1'] ,'RSN_META_ALL'));
META1=squeeze(META1(:,:,Cmax));

META2=struct2array(load([SOURCE_PROJECT 'RUN2/LEiDA_KOP_ALL_RUN2'] ,'RSN_META_ALL'));
