...
R2<-format(sumSCHZ$r.squared,digits=2,nsmall=1)
R2adj<-format(sumSCHZ$adj.r.squared, digits=2,nsmall=1)
...
ggsave('Figures/01_INT_SEG_COBRE.pdf', width=60, height=20, units="cm")
