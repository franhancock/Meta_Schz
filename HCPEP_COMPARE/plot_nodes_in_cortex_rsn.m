function plot_nodes_in_cortex_rsn (V,orient)
...
YeoColor = [120 18 134; 70 30 180; 0 118 14; 196 58 250; 220 248 164; 230 148 34; 205 62 78; 0 0 256; 0 0 0; 1 1 1]./256;
...
for n=1:length(V)
        ...
        surf(x+MNI_coord(n,2)+ori(1), y+MNI_coord(n,1)+ori(2),z+MNI_coord(n,3)+ori(3),'FaceColor',YeoColor(rsn,:),'EdgeColor','none','FaceAlpha',0.7);
end
