...
for run=1:Rmax
    ...
    load([PROJECT MET_FOLDER 'LEiDA_Kmeans_results'],'Kmeans_results','rangeK')
    load([PROJECT MET_FOLDER 'LEiDA_EigenVectors'],'Time_sessions')
    ...
    save([PROJECT MET_FOLDER save_file],'P','LT')
end
